...
const BackendConfigScreen = () => {
    ...
    try {
      ...
      if (savedUrl) {
        ...
        if (oldUrls.some(oldUrl => savedUrl.includes(oldUrl))) {
          ...
          const defaultUrl = 'http://3.82.200.97:3000';
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      if (isConnected) {
        ...
        setTestResult({
          success: false,
          message: '❌ No se pudo conectar al servidor. Verifica la URL y que el servidor esté activo.'
        });
  ...
  const loadPreset = (presetName: string) => {
    const presets: { [key: string]: string } = {
      ...
      'production': 'http://3.82.200.97:3000'
    };
        ...
        >
          ...
          <View style={styles.infoSection}>
            ...
            <Text style={styles.infoText}>
              ...
              • El puerto por defecto es 7300{'\n'}
              • Usa 10.0.2.2 para emulador Android (apunta a localhost){'\n'}
